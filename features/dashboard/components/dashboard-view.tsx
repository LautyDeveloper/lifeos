        ...
        <div className="grid gap-5 xl:grid-cols-[1.35fr_0.8fr]">
          <section className="surface-1 rounded-2xl border p-5 md:p-6 xl:col-span-2">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Quick actions</p>
                <h3 className="mt-2 text-xl font-semibold text-white">Movete sin cambiar de pantalla</h3>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Capturá, guardá contexto o saltá directo a ejecutar.
                </p>
              </div>
              <Link href="/today" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-primary/20 bg-primary/10 px-4 text-sm font-medium text-primary hover:text-white">
                <CalendarCheck2 className="size-4" />
                Ir a Hoy
              </Link>
            </div>

            <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_1fr_0.72fr]">
              <div className="rounded-2xl bg-white/[0.02] p-1">
          ...
          <section className="surface-1 rounded-2xl border p-5 md:p-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Contexto vivo para decidir mejor.</p>
              </div>
              ...
              {summary.recentLibraryNotes.length ? (
                summary.recentLibraryNotes.map((note) => (
                  <Link
                    ...
                    className="block rounded-xl border border-white/8 bg-white/[0.025] p-4 transition hover:border-primary/20 hover:bg-white/[0.04]"
                  >
